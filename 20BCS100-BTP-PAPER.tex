...
% Page Layout
\usepackage{geometry}
\geometry{margin= 1.55cm} % Adjust as needed
...
\vspace*{0.5 cm}
    ...
    \textbf{Keywords:} Ransomware, Detection Application, Cybersecurity, Machine Learning, Behavioral Analysis, Threat Mitigation, Real-time Protection, Cyber Threats, Digital Security, Antivirus Solutions.
...
% Image Embed
\begin{figure*}[ht]
  \includegraphics[width=\textwidth, height= 8.5 cm]{images/20180214-Free-Ransomware-1.png} % Replace example-image with your actual image file
